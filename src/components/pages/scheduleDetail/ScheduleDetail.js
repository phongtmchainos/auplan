        ...
        return (
            <div className="main-component">
                ...
                <div className="schedule-detail">
                    <div className="card_schedule container-fluid">
                        <div className="schedule">
                            <div className="content">
                                ピクサー・ザ・フレンドシップ <br/>
                                ～仲間といっしょに冒険の世界へ
                                <div className="date">
                                    <div className="from">4 <span>月</span> 28 <span>日</span> <span
                                        className="blue">(土)</span></div>
                                    <img src={require('../../../icons/arrown-right.png')} alt=""/>
                                    <div className="to">5 <span>月</span> 6 <span>日</span> <span
                                        className="red">(日)</span></div>
                                </div>
                                <div className="house">
                                    9:00-18:30
                        ...
                        <div className="prince_icon">
                            <div className="row">
                                ...
                                <div className="col-xs-3"><img src={require('../../../icons/ic_like.png')}
                                                               alt=""/> 3496
                                </div>
                    ...
                    <div className="cv">
                        <div className="container-fluid">
                            <div className="cv_bnt">
                                <button><span><img src={require('../../../icons/ic_follow2.png')} alt=""/></span>スケジュールをフォロー
                                </button>
                            </div>
                            <div className="cv_bnt">
                                <button><span><img src={require('../../../icons/ic_follow2.png')} alt=""/></span>スケジュールを追加
                                </button>
                            </div>
                            <div className="cv_bnt cv_bnt2">
                                <Link to="/schedule-new-entry">
                                    <button><span><img src={require('../../../icons/ic_Schedule2.png')} alt=""/></span>スケジュールを編集
                                    </button>
                                </Link>
                            </div>
                        </div>
                    ...
                    <div className="place">
                        ...
                        <div className="container-fluid">
                            ...
                            <div className="pin"><span><img src={require('../../../icons/ic_pin.png')} alt=""/></span>地図を見る
                            </div>
                        </div>
                    </div>
                    <div className="link">
                    ...
                    <div id="user">
                        ...
                        <div className="container-fluid">
                            <div className="card_user">
                                <div className="row">
                                    <div className="col-xs-3 user_name">
                                        <Link to="/my-user">
                                            <img src={require('../../../icons/user_img.png')} alt=""/>
                                        </Link>
                                    </div>
                                ...
                                <div className="form-group">
                                    <div className="col-sm-12">
                                        <span className="form-control-start"><img
                                            src={require('../../../icons/ic_comment.png')} alt=""/></span>
                                        <input type="email" className="form-control" placeholder="Enter email"
                                               defaultValue="コメントする"/>
                                        <span className="form-control-feedback"><img
                                            src={require('../../../icons/ic_delete.png')} alt=""/></span>
                                    </div>
                                </div>
                            </div>
                            <div className="form-group">
                                <div className="user">
                                    <div className="row">
                                        <div className="col-xs-2"><img src={require('../../../icons/user_img.png')}
                                                                       alt=""/></div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-xs-10 ">
                                            <div className=" comment_item">
                                                <div className="row">
                                                    <div className="col-xs-6 name">宮島 太郎</div>
                                                    <div className="col-xs-6 date">４月２８日（日）</div>
                                                </div>
                                                <div className="content">
                                                    コメントが入ります○あああああああああ■あああああああああ！
                                                </div>
                    ...
                    <div className="prince_icon">
                        ...
                        <div className="cv_bnt_l">
                            <button><span><img src={require('../../../icons/ic_follow2.png')} alt=""/></span>スケジュールをフォロー/購入
                            </button>
                        </div>
                    </div>
                    <div className="recommended">
                        <Calendars tagPage="scheduleDetail"/>
                        <Schedules tagPage="scheduleDetail"/>
                    </div>
                </div>
            </div>
        )
