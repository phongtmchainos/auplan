    ...
    return (
      <div id="notice">
        <div className=" notice_header">
          <div className="cancel col-xs-4">キャンセル</div>
          <div className="title col-xs-4">お知らせ</div>
        ...
        <div className="notice_content">
          ...
          <div className="notice_items">
            <div className="container-fluid">
              ...
              <div className="user ">
                <div className="user_icon"> <img src={require('../../../icons/icon.png')}  alt="icon"/></div>
                <div className="user_content">
                  <div className="user_name">宮島 太郎 <span>さんが日付を変更しました。</span></div>
                  <div className="calander">
                    <span><img src={require('../../../icons/ic_calender_blue.png')}  alt="ic_calender_blue"/></span>
                    プロ野球 横浜DeNAベイスターズ公式戦
                </div>
                <div className="date_houser">
                  <div className="date">
                    4 <span>月</span> 28 <span>日</span> <span className="date_from">(土)</span>
                    <img src={require('../../../icons/arrown-right.png')}  alt="arrown-right"/>
                  ...
                  <div className="inner">
                    <div className="follow"><img src={require('../../../icons/ic_follow.png')}  alt="ic follow"/>
                      989
                    </div>
                    <div className="like">
            ...
            <div className="container-fluid">
              ...
              <div className="user">
                ...
                <div className="user_content">
                  ...
                  <div className="calander">
                    <span><img src={require('../../../icons/ic_schedule_48px.png')}  alt="ic_schedule_48px"/></span>
                ...
                <div className="date_houser">
                  ...
                  <div className="date">
                    ...
                    <img src={require('../../../icons/ic_arrow_right.png')}  alt="ic_arrow_right"/>
                  ...
                  <div className="inner">
                    <div className="follow"><img src={require('../../../icons/ic_follow.png')}  alt="ic_follow"/>
                      989
                    </div>
                    <div className="like">
                      <img src={require('../../../icons/ic_like2.png')}  alt="ic_like2"/>
            ...
            <div className="container-fluid">
              ...
              <div className="user">
                ...
                <div className="user_content">
                  <div className="user_name">Miyashima hanako <span>さんが時間を変更しました。</span></div>
                  <div className="calander">
                    <span><img src={require('../../../icons/ic_schedule_48px.png')}  alt="ic schedule"/></span>
                    ピクサー・ザ・フレンドシップ <br />～仲間といっしょに冒険の世界へ
                </div>
            ...
            <div className="container-fluid">
              ...
              <div className="user ">
                ...
                <div className="date_houser">
                  ...
                  <div className="inner">
                    <div className="follow"><img src={require('../../../icons/ic_follow.png')}  alt=""/>
                      989
                    </div>
                    <div className="like">
