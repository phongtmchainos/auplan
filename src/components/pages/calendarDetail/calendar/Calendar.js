...
const CustomToolbar = (props) => {
    return (
        <div className="custom-toolbar">
            ...
            <span onClick={() => props.onNavigate('PREV')}>
              <img className="icon-switch-month" src={require('../../../../icons/arrow-left.png')} alt=""/>
            </span>
            </div>
            ...
            <span onClick={() => props.onNavigate('NEXT')}>
              <img className="icon-switch-month" src={require('../../../../icons/arrown-right.png')} alt=""/>
            </span>
            </div>
        </div>
    )
